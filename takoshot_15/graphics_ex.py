...
def draw_player_status(player):
    ...
    draw_status(player, graphics_hud, UI_PLAYER_BAR_WIDTH, UI_PLAYER_BAR_HEIGHT)

def draw_status(player, gra_hud, bar_width, bar_height):
    gra_hud.fill(0)
    ...
    surf = gra_hud.target
    g.graphics.blit(surf, (player.x - surf.get_width() * 0.5, player.y + yy))
