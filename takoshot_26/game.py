...
class Game:
    ...
    def load2(self, btlinit_info):
        self.create_world(btlinit_info.stage_id)
        
        p_list = self.world.stage.create_start_point_list()
        p_list = random.sample(p_list, 2)
        self.world.add_player2(btlinit_info.player_0, *p_list[0])
        self.world.add_player2(btlinit_info.player_1, *p_list[1])
