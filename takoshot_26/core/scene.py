class Scene:
    ...
    def __init__(self, systems, id = None):
...
class Scene_Container(Scene):
    ...
    def __init__(self, systems, id):
        super().__init__(systems, id)
    ...
    def update_children(self):
        ...
        for child in snapshot:
            ...
            # シーンを更新したら更新時間を書き込む
            if(not exclusive): child.last_update_time_ms = self.systems.time_sys.sys_time_ms
