...
# python -m trial.transform_2 を入力し実行
# python -m debugpy --wait-for-client --listen 5678 try/try_transform_2.py を入力し、リモートデバッグ実行
...
class Scene_TryTransform(Scene):
    ...
    def render(self):
        ...
        stage_img = g.systems.res_sys.stage.bitmap(1)
