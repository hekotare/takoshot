...
from defines import MAX_SHOT_VELOCITY, SHOT_COMMAND_LIST, Dir, ShellType, clamp, play_se
...
class World:
    ...
    def add_player(self, x, y):
        ...
        p = Player(self, ChrType.ORANGE, x, y, f"player_{len(self.player_list)}")
    ...
    def add_player2(self, chr_type, x, y):
        ...
        p = Player(self, chr_type, x, y, f"player_{len(self.player_list)}")
        self.player_list.append(p)
