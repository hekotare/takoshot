...
from defines import BattleInitInfo, ChrType, SceneId, play_bgm, stop_bgm
...
class Scene_GameRoot(Scene_Container):
    ...
    def __init__(self):
        super().__init__(SceneId.GAME_ROOT)
...
class Scene_PreparingForBattle(Scene_Container):
    ...
    def __init__(self):
        super().__init__(SceneId.PREPARING_FOR_BATTLE)
    ...
    def prepare(self):
        ...
        menu_cntr.add_item(MenuItem(0)) # stage
